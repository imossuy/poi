...
//        drawSheet5( sheet5, wb );
    ...
    private static void drawSheet5( HSSFSheet sheet5, HSSFWorkbook wb ) throws IOException
    {
        ...
        patriarch.createPicture(anchor, loadPicture( "/Users/dxy/Desktop/xls2xlsx/logoKarmokar4.png", wb ));

        anchor = new HSSFClientAnchor(0,0,0,255,(short)4,2,(short)5,7);
        anchor.setAnchorType( AnchorType.MOVE_DONT_RESIZE );
        patriarch.createPicture(anchor, loadPicture( "/Users/dxy/Desktop/xls2xlsx/logoKarmokar4edited.png", wb ));

        anchor = new HSSFClientAnchor(0,0,1023,255,(short)6,2,(short)8,7);
        anchor.setAnchorType( AnchorType.MOVE_DONT_RESIZE );
        HSSFPicture picture = patriarch.createPicture(anchor, loadPicture( "/Users/dxy/Desktop/xls2xlsx/logoKarmokar4s.png", wb ));
